...
>(
  (
    ...
    // We use collapsedProp and setCollapsedProp for control from outside the component.
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [isCollapsed, setCollapsed, isMobile, openMobile, setOpenMobile, toggleSidebar]
    )
...
>(
  (
    ...
    const { isMobile, isCollapsed, openMobile, setOpenMobile, toggleSidebar } = useSidebar()
